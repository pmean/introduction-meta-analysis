...
## Fixed effects model
 ...
 $V(\hat \theta_i) \approx \frac{1}{n_T}+\frac{1}{n_C}; \;\;\; w_i = \frac{1}{V(\hat \theta_i)}$ 

 $\hat \theta = \frac{\Sigma w_i \hat \theta_i}{\Sigma w_i}; \;\;\; V(\hat \theta) = \frac{1}{\Sigma w_i}$ 
...
The variance of the standardized mean difference is a simple function of the sample sizes in the treatment and control. You should calculate a weight equal to the inverse of the variance to insure that the studies with the largest sample sizes (and thus the greatest precision) get weighted more heavily.
